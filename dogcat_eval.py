...
"""Evaluation for dogcat.

Accuracy:
dogcat_train.py achieves 83.0% accuracy after 100K steps (256 epochs
of data) as judged by dogcat_eval.py.

Speed:
On a single Tesla K40, dogcat_train.py processes a single batch of 128 images
...
tf.app.flags.DEFINE_string('eval_dir', '/input/dogcat_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/input/dogcat_train',
